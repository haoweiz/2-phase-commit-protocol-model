...
\@x{ {\CONSTANTS} RM ,\,\@s{85.49}}%
\@y{\@s{0}%
 The number of resource managers.
}%
\@xx{}%
\@x{\@s{54.75} BTM ,\,\@s{78.59}}%
\@y{\@s{0}%
 Whether have \ensuremath{backupTM}.
}%
\@xx{}%
\@x{\@s{54.75} RMMAYFAIL ,\,\@s{41.0}}%
\@y{\@s{0}%
 Whether \ensuremath{RM} could fail.
}%
\@xx{}%
\@x{\@s{54.75} TMMAYFAIL\@s{47.24}}%
\@y{\@s{0}%
 Whether \ensuremath{TM} could fail.
}%
\@xx{}%
\@pvspace{32.0pt}%
\pcalsymbolstrue
...
\@x{ {\p@mmalgorithm} TransactionCommit {\p@lbrace}}%
 ...
 \.{\mapsto}\@w{working} ] ,\,}%
\@x{\@s{51.42} tmState\@s{0.89} \.{=}\@w{init} {\p@semicolon}\@s{110.7}}%
\@y{\@s{0}%
 \ensuremath{tmState}\mbox{'}s \ensuremath{init} state.
}%
\@xx{}%
\@x{\@s{51.42} btmState \.{=}\@w{init} {\p@semicolon}\@s{106.99}}%
\@y{\@s{0}%
 \ensuremath{backupTM}\mbox{'}s \ensuremath{init} state.
}%
\@xx{}%
\@x{\@s{8.2} {\p@define} {\p@lbrace}}%
 \@x{\@s{16.4} canCommit \.{\defeq} \A\, rm \.{\in} RM \.{:} rmState [ rm ]
 \.{\in} \{\@w{prepared} ,\,\@w{committed} \}}%
\@y{%
 If some \ensuremath{rm} are commited or all \ensuremath{rm} are commited,
}%
\@xx{}%
\@x{\@s{329.33}}%
\@y{%
 which means \ensuremath{tmState} is \ensuremath{\@w{commit}}, sowe can
 commit.
}%
\@xx{}%
 \@x{\@s{16.4} canAbort \.{\defeq} \A\, rm \.{\in} RM \.{:} rmState [ rm ]
 \.{\neq}\@w{committed}\@s{4.1}}%
\@y{%
 if no \ensuremath{rm} are committed, we don\mbox{'}t know the state of
 \ensuremath{tmState},
}%
\@xx{}%
\@x{\@s{260.75}}%
\@y{%
 if \ensuremath{tmState} is not \ensuremath{\@w{commit}}, we cannot commit.
}%
\@xx{}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{8.2} {\p@macro} Prepare {\p@lparen} p {\p@rparen} {\p@lbrace}}%
 \@x{\@s{16.4} {\p@await} rmState [ p ] \.{=}\@w{working}
 {\p@semicolon}\@s{4.1}}%
\@y{%
 if \ensuremath{rmState[p]} is working, then it will be prepared
}%
\@xx{}%
\@x{\@s{24.59} rmState [ p ] \.{:=}\@w{prepared} {\p@semicolon}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{8.2} {\p@macro} Decide {\p@lparen} p {\p@rparen} {\p@lbrace}}%
 \@x{\@s{16.4} {\p@either} {\p@lbrace} {\p@await} rmState [ p ]
 \.{=}\@w{prepared} \.{\land} canCommit \.{\land} ( tmState \.{=}\@w{commit}
 \.{\lor} btmState \.{=}\@w{commit} ) {\p@semicolon}\@s{16.4}}%
\@y{%
 If \ensuremath{rmState[p]} is prepared, some \ensuremath{rm} is committed and
}%
\@xx{}%
\@x{\@s{494.35}}%
\@y{%
 if we have \ensuremath{backupTM}, either \ensuremath{tmState} or
 \ensuremath{btmState} is \ensuremath{\@w{commit}},
}%
\@xx{}%
\@x{\@s{494.35}}%
\@y{%
 then we can change \ensuremath{rmState} to \ensuremath{\@w{commit}}.
}%
\@xx{}%
\@x{\@s{59.14} rmState [ p ] \.{:=}\@w{committed} {\p@semicolon}}%
\@x{\@s{49.56} {\p@rbrace}}%
 \@x{\@s{16.4} {\p@or}\@s{18.84} {\p@lbrace} {\p@await} rmState [ p ] \.{\in}
 \{\@w{working} ,\,\@w{prepared} \} \.{\land} canAbort
 {\p@semicolon}\@s{151.7}}%
\@y{%
 If not all \ensuremath{rmState} is committed, we can abort at any time.
}%
\@xx{}%
\@x{\@s{59.14} rmState [ p ] \.{:=}\@w{abort}}%
\@x{\@s{49.56} {\p@rbrace}}%
\@x{\@s{8.2} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{8.2} {\p@macro} Fail {\p@lparen} p {\p@rparen} {\p@lbrace}}%
 \@x{\@s{20.5} {\p@if} {\p@lparen} RMMAYFAIL {\p@rparen}\@s{4.1} rmState [ p ]
 \.{:=}\@w{crash}\@s{127.1}}%
\@y{%
 If \ensuremath{RMMAYFAIL}, \ensuremath{rmState[p]} could be
 \ensuremath{\@w{crash}
}}%
\@xx{}%
\@x{\@s{8.2} {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{8.2} {\p@fair}\@s{7.72} {\p@process} {\p@lparen} RManager \.{\in} RM
 {\p@rparen} {\p@lbrace}\@s{168.09}}%
\@y{%
 If \ensuremath{rmState} is working or prepared, it should execute until
 abort or commit if we
}%
\@xx{}%
 \@x{\@s{16.4} RS\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} rmState [ self
 ] \.{\in} \{\@w{working} ,\,\@w{prepared} \} {\p@rparen}
 {\p@lbrace}\@s{82.06}}%
\@y{%
 set up \ensuremath{backupTM}. Otherwise termination might be violated.
}%
\@xx{}%
 \@x{\@s{44.99} {\p@either} Prepare ( self ) {\p@or} Decide ( self ) {\p@or}
 Fail ( self ) {\p@rbrace}}%
\@x{\@s{8.2} {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{8.2} {\p@fair} {\p@process} {\p@lparen} TManager \.{=} 0 {\p@rparen}
 {\p@lbrace}\@s{203.13}}%
\@y{%
 If all \ensuremath{rm} are prepared, it\mbox{'}s time to commit, so set
 \ensuremath{tmState} to commit.
}%
\@xx{}%
 \@x{\@s{8.2} TS\@s{.5}\textrm{:}\@s{3} {\p@either} {\p@lbrace} {\p@await}
 canCommit {\p@semicolon}}%
 \@x{\@s{44.85} TC\@s{.5}\textrm{:}\@s{3}\@s{4.30} tmState \.{:=}\@w{commit}
 {\p@semicolon}}%
 \@x{\@s{71.20} {\p@if} {\p@lparen} BTM {\p@rparen} btmState \.{:=}\@w{commit}
 {\p@semicolon}\@s{135.30}}%
\@y{%
 If we set \ensuremath{backupTM}, change the \ensuremath{btmState} just the
 same as \ensuremath{tmState}.
}%
\@xx{}%
 \@x{\@s{44.85} F1\@s{.5}\textrm{:}\@s{3}\@s{7.21} {\p@if} {\p@lparen}
 TMMAYFAIL {\p@rparen} tmState \.{:=}\@w{hidden} {\p@semicolon} {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{28.45} {\p@or} {\p@lbrace} {\p@await} canAbort
 {\p@semicolon}\@s{236.17}}%
\@y{%
 Abort can appear any time unless all \ensuremath{rmState} are committed.
}%
\@xx{}%
 \@x{\@s{42.77} TA\@s{.5}\textrm{:}\@s{3} tmState \.{:=}\@w{abort}
 {\p@semicolon}}%
 \@x{\@s{71.07} {\p@if} {\p@lparen} BTM {\p@rparen} btmState \.{:=}\@w{abort}
 {\p@semicolon}\@s{144.76}}%
\@y{%
 If we set \ensuremath{backupTM}, change the \ensuremath{btmState} just the
 same as \ensuremath{tmState}.
}%
\@xx{}%
 \@x{\@s{42.77} F2\@s{.5}\textrm{:}\@s{3}\@s{0.96} {\p@if} {\p@lparen}
 TMMAYFAIL {\p@rparen} tmState \.{:=}\@w{hidden} {\p@semicolon} {\p@rbrace}}%
\@x{\@s{12.29} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@xx{}%
 \@x{ canCommit \.{\defeq} \A\, rm \.{\in} RM \.{:} rmState [ rm ] \.{\in}
 \{\@w{prepared} ,\,\@w{committed} \}}%
\@pvspace{8.0pt}%
 \@x{ canAbort \.{\defeq} \A\, rm \.{\in} RM \.{:} rmState [ rm ]
 \.{\neq}\@w{committed}}%
\@pvspace{16.0pt}%
 \@x{ vars \.{\defeq} {\langle} rmState ,\, tmState ,\, btmState ,\, pc
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} ( RM ) \.{\cup} \{ 0 \}}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@x{\@s{35.70} \.{\land} btmState \.{=}\@w{init}}%
 ...
 self \.{\in} RM \.{\rightarrow}\@w{RS}}%
\@x{\@s{160.39} {\Box}\@s{10.30} self \.{=} 0 \.{\rightarrow}\@w{TS} ]}%
\@pvspace{8.0pt}%
\@x{ RS ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{RS}}%
 \@x{\@s{57.21} \.{\land} {\IF} rmState [ self ] \.{\in} \{\@w{working}
 ,\,\@w{prepared} \}}%
 \@x{\@s{80.47} \.{\THEN} \.{\land} \.{\lor} \.{\land} rmState [ self ]
 \.{=}\@w{working}}%
 \@x{\@s{134.01} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 self ] \.{=}\@w{prepared} ]}%
 \@x{\@s{122.89} \.{\lor} \.{\land} \.{\lor} \.{\land} rmState [ self ]
 \.{=}\@w{prepared} \.{\land} canCommit \.{\land} ( tmState \.{=}\@w{commit}
 \.{\lor} btmState \.{=}\@w{commit} )}%
 \@x{\@s{156.23} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 self ] \.{=}\@w{committed} ]}%
 \@x{\@s{145.12} \.{\lor} \.{\land} rmState [ self ] \.{\in} \{\@w{working}
 ,\,\@w{prepared} \} \.{\land} canAbort}%
 \@x{\@s{156.23} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [
 self ] \.{=}\@w{abort} ]}%
\@x{\@s{122.89} \.{\lor} \.{\land} {\IF} RMMAYFAIL}%
 \@x{\@s{157.27} \.{\THEN} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT}
 {\bang} [ self ] \.{=}\@w{crash} ]}%
\@x{\@s{157.27} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{188.58} \.{\land} {\UNCHANGED} rmState}%
 \@x{\@s{111.78} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{RS} ]}%
 \@x{\@s{80.47} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [
 self ] \.{=}\@w{Done} ]}%
\@x{\@s{111.78} \.{\land} {\UNCHANGED} rmState}%
 \@x{\@s{57.21} \.{\land} {\UNCHANGED} {\langle} tmState ,\, btmState
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RManager ( self ) \.{\defeq} RS ( self )}%
\@pvspace{8.0pt}%
...
\@x{\@s{34.65} \.{\land} tmState \.{'} \.{=}\@w{commit}}%
\@x{\@s{34.65} \.{\land} {\IF} BTM}%
\@x{\@s{57.91} \.{\THEN} \.{\land} btmState \.{'} \.{=}\@w{commit}}%
\@x{\@s{57.91} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{89.22} \.{\land} {\UNCHANGED} btmState}%
...
\@x{\@s{57.91} \.{\THEN} \.{\land} tmState \.{'} \.{=}\@w{hidden}}%
\@x{\@s{57.91} \.{\ELSE} \.{\land} {\TRUE}}%
...
\@x{\@s{34.65} \.{\land} tmState \.{'} \.{=}\@w{abort}}%
\@x{\@s{34.65} \.{\land} {\IF} BTM}%
\@x{\@s{57.91} \.{\THEN} \.{\land} btmState \.{'} \.{=}\@w{abort}}%
\@x{\@s{57.91} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{89.22} \.{\land} {\UNCHANGED} btmState}%
 \@x{\@s{34.65} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{F2} ]}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ consistency \.{\defeq} tmState \.{=}\@w{commit} \.{\implies} \A\, i
 \.{\in} RM \.{:} rmState [ i ] \.{\neq}\@w{abort}}%
 \@x{\@s{49.95} \.{\land}\@s{7.77} tmState \.{=}\@w{abort} \.{\implies} \A\, j
 \.{\in} RM \.{:} rmState [ j ] \.{\neq}\@w{committed}}%
 \@x{\@s{49.95} \.{\land}\@s{7.77} tmState \.{=}\@w{hidden} \.{\implies} \A\,
 k \.{\in} RM \.{:} rmState [ k ] \.{\neq}\@w{committed}}%
 \@x{ terminate \.{\defeq} {\Diamond} ( \A\, i \.{\in} RM \.{:} rmState [ i ]
 \.{\in} \{\@w{committed} ,\,\@w{abort} ,\,\@w{crash} \} )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*1.2 \ensuremath{TMMAYFAIL} is true and
 \ensuremath{RMMAYFAIL} is false means \ensuremath{tmState} could be
 \ensuremath{\@w{hidden}} and \ensuremath{rmState} cannot be
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*hidden. In this situation, termination will
 be violated. For example, when \ensuremath{TM} is \ensuremath{\@w{commit}}
 and some
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*\ensuremath{RM} are committed, then
 \ensuremath{TM} crashed while some other \ensuremath{RM} is prepared, but
 they can never be \ensuremath{\@w{commit}} or \ensuremath{abort
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*because \ensuremath{TM} is
 \ensuremath{\@w{hidden}} now. That\mbox{'}s why we get result when
 \ensuremath{RM} equals 3 that
 \ensuremath{{\langle}\@w{committed},\,\@w{prepared},\,\@w{committed}{\rangle}}.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*It will never been terminated because
 \ensuremath{\@w{prepared}} has no way to \ensuremath{\@w{commit}}.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*1.3 \ensuremath{Termination} and comsistency
 remain true. The states cancommit and canabort is owned by both
 \ensuremath{BTM} and \ensuremath{TM}.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* So when \ensuremath{TM} crashes, the
 \ensuremath{RMs} can still consult the \ensuremath{BTM} and make their
 decision.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*If an \ensuremath{RM} crashed, then all other
 \ensuremath{RMs} can only abort. So all other uncrashed \ensuremath{RMs}
 remain consistent.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Dec} 05 19:55:47 \ensuremath{EST} 2017 by \ensuremath{lenovo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Nov} 29
 17:13:20 \ensuremath{EST} 2017 by \ensuremath{lenovo
}%
\end{cpar}%
\vshade{15.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*Group Members
 \ensuremath{xhu7}:\ensuremath{xhu7}@\ensuremath{buffalo.edu
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}*\ensuremath{Haowei} \ensuremath{Zhou}
 haoweizh@\ensuremath{buffalo.edu
}%
\end{cpar}%
\end{lcom}%
\end{document}
